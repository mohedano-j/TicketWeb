...
axios_1.default.interceptors.response.use(function (response) {
    alert("We are in axios response interceptor");
    return response;
});
...
//    var wresultCleared = (wresultNode[0].getAttribute('value')).replace(/&lt;/g, '<').replace(/&gt;/g, '>').replace(/&amp;/g, '&').replace(/&quot;/g, '"');
...
//}
//# sourceMappingURL=ssoPost.js.map